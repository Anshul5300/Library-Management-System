...
public class AdminMenu {
	...
	private void initialize() {
		...
		btnNewButton.setBounds(40, 85, 141, 30);
		...
		btnDeleteBook.setBounds(234, 85, 141, 30);
		...
		JButton btnListOfBooks = new JButton("List of Books");
		btnListOfBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Table.main(null);
			}
		});
		btnListOfBooks.setBounds(147, 215, 97, 25);
		frame.getContentPane().add(btnListOfBooks);
	}
}
